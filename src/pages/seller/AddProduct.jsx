...
const AddProduct = () => {
  ...
  return (
    <div className="no-scrollbar flex-1 h-[99vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    ...
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        <label onChange={(e)=> setOfferPrice(e.target.value)} value={offerPrice} className="text-base font-medium" htmlFor="offer-price">Offer Price</label>
                ...
                <button className="px-8 py-2.5 bg-purple-800 text-white font-medium rounded cursor-pointer">ADD</button>
            </form>
        </div>
  )
}
